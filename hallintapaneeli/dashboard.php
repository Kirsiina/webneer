...
$query = "SELECT COUNT(*) FROM `webneer_tilaukset` WHERE tilauspvm > (NOW() - INTERVAL 30 DAY) ";
$result = mysqli_query($yhteys, $query);
$tilausamount = mysqli_fetch_row($result);
?>
...
<div class="wrapper" >
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card text-center">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Orders (Past 30 days)</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $tilausamount[0]; ?></div>
            </div>
        </div>
